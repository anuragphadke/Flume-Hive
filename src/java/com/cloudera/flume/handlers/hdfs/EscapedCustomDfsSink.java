...
public class EscapedCustomDfsSink extends EventSink.Base {
  ...
  public EscapedCustomDfsSink(String path, String filename, String hiveTableName, OutputFormat o) {
    this.path = path;
    this.filename = filename;
    shouldSub = Event.containsTag(path) || Event.containsTag(filename);
    this.format = o;
  ...
  public EscapedCustomDfsSink(String path, String filename, String hiveTableName, OutputFormat o, String elasticSearchUrl, String elasticIndex, String elasticType, boolean runMarkerQueries) {
    this.path = path;
    this.filename = filename;
  ...
  public EscapedCustomDfsSink(String path, String filename, String hiveTableName) {
  ...
  public EscapedCustomDfsSink(String path, String filename, String hiveTableName, String elasticSearchUrl, String elasticIndex, String elasticType, boolean runMarkerQueries) {
    this(path, filename, hiveTableName, getDefaultOutputFormat(), elasticSearchUrl, elasticIndex, elasticType, runMarkerQueries);
  }

  protected CustomDfsSink openWriter(String p, Event e) throws IOException {
    //LOG.info("Opening " + p);
    CustomDfsSink w;
