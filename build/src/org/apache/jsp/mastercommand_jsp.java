...
public final class mastercommand_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      synchronized (session) {
        rawcmd = (com.cloudera.flume.master.commands.GenericCommand) _jspx_page_context.getAttribute("rawcmd", PageContext.SESSION_SCOPE);
        if (rawcmd == null){
          rawcmd = new com.cloudera.flume.master.commands.GenericCommand();
          _jspx_page_context.setAttribute("rawcmd", rawcmd, PageContext.SESSION_SCOPE);
        }
      }
      out.write('\n');
